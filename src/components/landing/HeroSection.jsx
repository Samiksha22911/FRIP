        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-accent/10 border border-accent/20 mb-8">
            ...
            <span className="text-sm font-medium text-accent-foreground">
              Faculty Research Impact Portal
            </span>
          </div>
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
            A unified platform for managing faculty publications, conference
            attendance, and research contributions — with real-time rankings and
            analytics.
          </p>
