 ...
 *
 * Shows all submitted publications with approve / reject / delete controls.
 * No built-in forms, no journal/conference/book cards.
 */
...
import PublicationsTable from "@/components/PublicationsTable";
import { RejectReasonDialog } from "@/components/SubmissionDialogs";
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Manage all submitted publications here. Approve, reject, or delete
          publication records.
        </p>
      </div>
      ...
      <PublicationsTable
        rows={rows}
        title="All Publication Submissions"
        description="Approve, reject, view details, or delete submissions."
        manageActions
        onApprove={handleApprove}
        onReject={(p) => setRejectTarget(p)}
      />
